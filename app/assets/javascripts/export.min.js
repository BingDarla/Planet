  ...
  var a, i = {
    ...
    capture: function(e, t) {
      ...
      for (i.setup.fabric = new fabric.Canvas(i.setup.canvas, u), i.deepMerge(i.setup.fabric, r), i.deepMerge(i.setup.fabric.freeDrawingBrush, r.drawing), i.deepMerge(i.drawing, r.drawing), i.drawing.handler.change(r.drawing), i.setup.fabric.on("mouse:down", function(e) {
          i.gatherPosition(e.e, 1), i.drawing.buffer.pressedTS = Number(new Date), i.isPressed(e.e), i.drawing.buffer.isDrawing = !1, i.drawing.buffer.isDrawingTimer = setTimeout(function() {
      ...
      if (0 == s.data.length)
        if ("stock" == i.setup.chart.type) {
          for (s.data = i.cloneObject(i.setup.chart.mainDataSet.dataProvider), t(i.setup.chart.mainDataSet.categoryField), s.dateFields.push(i.setup.chart.mainDataSet.categoryField), a = 0; a < i.setup.chart.mainDataSet.fieldMappings.length; a++)
            for (u = i.setup.chart.mainDataSet.fieldMappings[a], r = 0; r < i.setup.chart.panels.length; r++) {
              var d = i.setup.chart.panels[r];
              for (n = 0; n < d.stockGraphs.length; n++)
                for (v = d.stockGraphs[n], i4 = 0; i4 < l.length; i4++) v[l[i4]] == u.toField && t(u.fromField, v.title, l[i4])
            }
          if (i.setup.chart.comparedGraphs.length) {
            ...
            for (a = 0; a < i.setup.chart.comparedGraphs.length; a++)
              for (v = i.setup.chart.comparedGraphs[a], r = 0; r < v.dataSet.dataProvider.length; r++) {
        ...
        for (a = 0; a < i.setup.chart.graphs.length; a++)
          for (v = i.setup.chart.graphs[a], r = 0; r < l.length; r++) {
            var b = v[w = l[r]];
            v.title, t(b, v.title, w)
          }
            ...
            (void 0 === d.menu || d.menu.length) && (p.setAttribute("href", "#"), i.setup.hasTouch && c.classList ? (p.addEventListener("touchend", function(e, t) {
              ...
              return function(t) {
                ...
                var r = e.elements.li,
                  ...
                  }(r), r.getElementsByTagName("ul").length > 0);
